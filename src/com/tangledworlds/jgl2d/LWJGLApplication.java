package com.tangledworlds.jgl2d;

import com.tangledworlds.jgl2d.event.GLFWEventHandler;
import com.tangledworlds.jgl2d.exception.InitializationException;
...
public abstract class LWJGLApplication {
	 ...
	 * <ul>
	 * <li>initialize the {@link com.tangledworlds.jgl2d.graphics.window.WindowManager}</li>
	 ...
	 * <li>clean up the {@link com.tangledworlds.jgl2d.graphics.window.WindowManager}</li>
	 * </ul>
	 * 
